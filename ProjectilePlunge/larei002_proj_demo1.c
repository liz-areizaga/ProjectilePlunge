 ...
 *                        demo with a line of leds. Starts at b0, left is in the direction of lsb right is in the direction of msb
 *                        This completes the character movement part of my game.
 *
 *
 *	I acknowledge all content contained herein, excluding template or example
 *	code, is my own original work.
 *
 *	Demo URL: https://youtu.be/6xqISCjyJo4
 */
#include <avr/io.h>
#include "timer.h"
#ifdef _SIMULATE_
